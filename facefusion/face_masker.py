...
def collect_model_downloads() -> Tuple[DownloadSet, DownloadSet]:
	...
	if state_manager.get_item('face_occluder_model') == 'xseg_3':
		model_hashes['xseg_3'] = model_set.get('xseg_3').get('hashes').get('face_occluder')
		model_sources['xseg_3'] = model_set.get('xseg_3').get('sources').get('face_occluder')
